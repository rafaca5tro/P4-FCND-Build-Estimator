...
VectorXf QuadEstimatorEKF::PredictState(VectorXf curState, float dt, V3F accel, V3F gyro)
{
  ...
  //Convert the true acceleration from body frame to the global frame
...
// Code sources: 
// Udacity lessons and excercises  
// Estimation Quadrotors paper